...
$(document).ready(function() {
    for (i = 0; i < boho.length; i++) {
        $("#projects").append("<div id='imgcontainer" + [i] + "'><img onclick='lightbox(" + [i] + ")' id='k" + [i] + "' class='boho' src='/assets/images/Boho/" + boho[i] + ".jpg'/><div id='myModal' class='modal'> <span class = 'close'>&times;</span><img class='modal-content' id='img01'></div></div>");

    }

 if ($(window).width() > 769) {
    for (i = 0; i < boho.length; i++) {
        $("#ninja").append("<li><a class='ns-img' href='/assets/images/Boho/" + boho[i] + ".jpg'></a></li>")
