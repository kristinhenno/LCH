...
$(document).ready(function() {
    for (i = 0; i < sb.length; i++) {
        $("#projects").append("<div id='imgcontainersblife" + [i] + "'><img onclick='lightbox(" + [i] + ")' class='californiahomes' id='k" + [i] + "' src='/assets/images/Press/SB/" + sb[i] + ".png'/><div id='myModal' class='modal'> <span class = 'close'>&times;</span><img class='modal-content' id='img01'></div></div>");

    }
 if ($(window).width() > 769) {

    for (i = 0; i < sb.length; i++) {
        $("#ninja").append("<li><a class='ns-img' href='/assets/images/Press/SB/" + sb[i] + ".png'></a></li>")
}
    }
