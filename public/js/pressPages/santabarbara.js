...
$(document).ready(function() {
    for (i = 0; i < sb.length; i++) {
        $("#projects").append("<div id='imgcontainers" + [i] + "'><img onclick='lightbox(" + [i] + ")' id='k" + [i] + "' class='californiahomes' src='/assets/images/Press/Summer17/" + sb[i] + ".jpg'/><div id='myModal' class='modal'> <span class = 'close'>&times;</span><img class='modal-content' id='img01'></div></div>");
