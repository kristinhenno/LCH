...
$(document).ready(function() {
    for (i = 0; i < sb.length; i++) {
        $("#projects").append("<div id='imgcontainerED" + [i] + "'><img onclick='lightbox(" + [i] + ")' id='k" + [i] + "' class='californiahomes' src='/assets/images/Press/Eldorado/" + sb[i] + ".jpg'/><div id='myModal' class='modal'> <span class = 'close'>&times;</span><img class='modal-content' id='img01'></div></div>");

    }
 if ($(window).width() > 769) {

    for (i = 0; i < sb.length; i++) {
        $("#ninja").append("<li><a class='ns-img' href='/assets/images/Press/Eldorado/" + sb[i] + ".jpg'></a></li>")
}
    }
