...
var lolo = ["2", "lolo1", "3", "lolo2", "4", "lolo4", "6", "lolo6", "5", "lolo7"];
...
$(document).ready(function() {
    ...
    for (i = 0; i < lolo.length; i++) {
        $("#projects").append("<div class='imgcontainer" + [i] + "'><img onclick='lightbox(" + [i] + ")' id='lolo" + [i] + "' src='/assets/images/Before/Lolo/" + lolo[i] + ".jpg'/><div id='myModal' class='modal'> <span class = 'close'>&times;</span><img class='modal-content' id='img01'></div></div>");

    }
    if ($(window).width() > 769) {

        for (i = 0; i < lolo.length; i++) {
            $("#ninja").append("<li><a class='ns-img' href='/assets/images/Before/Lolo/" + lolo[i] + ".jpg'></a></li>")
